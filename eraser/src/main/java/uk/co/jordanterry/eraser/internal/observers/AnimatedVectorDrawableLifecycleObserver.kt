 ...
 * * [AnimatedVectorDrawable.stop], will be synced with a transition to [Lifecycle.State.RESUMED],
 * if the animation was running when paused
 *
 * Methods important for cleaning up after ourselves:
 * * [AnimatedVectorDrawable.clearAnimationCallbacks], when transition into the
 ...
 *
 * @property animatedVectorDrawable to be changed as the lifecycle being observed moves through
 * different states
 */
